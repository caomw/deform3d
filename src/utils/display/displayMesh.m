...
% h=trimesh(Mesh.f',Mesh.v(:,1),Mesh.v(:,2),Mesh.v(:,3),'edgecolor',params.edgecolor,'FaceAlpha', 0, 'EdgeAlpha', 1);
h=trimesh(Mesh.f',Mesh.v(:,1),Mesh.v(:,2),Mesh.v(:,3),'FaceAlpha', 0, 'EdgeAlpha', 0.4);
